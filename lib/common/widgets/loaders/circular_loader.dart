...
class MOCircularLoader extends StatelessWidget {
  ...
  const MOCircularLoader({
    super.key,
    this.foregroundColor = MOColors.white,
    this.backgroundColor = MOColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(MOSizes.lg),
