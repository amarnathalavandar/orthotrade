...
import '../../controllers/orders/search_controller.dart';
...
class SearchScreen extends StatelessWidget {
  ...
  final searchController = Get.put(MOSearchController());
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            decoration: const InputDecoration(
                prefixIcon: Icon(Iconsax.search_normal), hintText: 'Search'),
          ),
        ),
         ...
         MOGridLayout(
              ...
              itemBuilder: (_, index) =>
                  ...
                  MOFormCardVertical(
                    ...
                    title: searchController.searchResults[index].formName,
                  ))
              : const Text('No forms matching your search criteria'),
    ),
            ...
            return Wrap(
              children: brandController.allBrands
                  .map((brand) => GestureDetector(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(top: MOSizes.md),
          ...
          () {
            ...
            if (categoryController.allCategories.isEmpty) {
              ...
              return ListView.separated(
                ...
                separatorBuilder: (_, __) => const SizedBox(height: MOSizes.spaceBtwItems),
                ...
                itemBuilder: (_, index) => GestureDetector(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: MOSizes.spaceBtwItems / 2),
